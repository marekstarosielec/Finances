...
{
    private IDataSource? _transactionWithDocument = null;
    public IDataSource TransactionWithDocument 
    { 
        get
        {
            _transactionWithDocument ??= new JoinedDataSource(Transaction, Document, "DocumentId",
            ...
            return _transactionWithDocument;
        } } 
}
