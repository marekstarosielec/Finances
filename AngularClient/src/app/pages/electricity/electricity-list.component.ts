    ...
    ngOnInit(){
        ...
        .pipe(take(1)).subscribe(([electricity, transactions, documents]) =>{
            ...
            this.columns = [ 
                ...
                { title: 'Kwota', dataProperty: 'amount', additionalDataProperty1: 'currency',  pipe: 'amounwithemptyt', alignment: 'right', noWrap:true, conditionalFormatting: 'amount', component: 'amount', filterOptions: { currencyDataProperty: 'currency'} as AmountFilterOptions, customEvent: true},
