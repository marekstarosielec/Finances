...
export const APIS = [AccountingDatasetService, BalancesService, CurrenciesService, CurrencyExchangeService, DatasetService, DocumentDatasetService, DocumentsService, ElectricityService, GasService, MBankScrapperService, MazdaService, SantanderScrapperService, SkodaService, StatisticsService, TransactionsService, TutoringService, TutoringListService];
